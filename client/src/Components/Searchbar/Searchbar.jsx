...
function Searchbar({ setActualPage }) {
  ...
  return (
    <div className="tablet:flex h-full">
      <input
      type="search"
        className="border border-primary rounded p-2  focus:outline-none focus:border-primary mr-4"
      ...
      {location.pathname !== "/dashboard/productList" && (
        <select
          className="border border-primary rounded p-2 focus:outline-none focus:border-chiliRed"
      ...
      <button
        className="bg-primary transition duration-300 hover:bg-onyx text-whiteSmoke font-bold py-2 px-4 rounded m-1"
